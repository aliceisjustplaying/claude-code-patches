...
// Display help
if (showHelp) {
  console.log('Claude Code Thinking Visibility Patcher v2.1.7');
  console.log('==============================================\n');
...
// Thinking Visibility Patch (v2.1.7)
...
const thinkingSearchPattern = 'case"thinking":{if(!F&&!Z)return null;return K5.createElement(gkA,{addMargin:Q,param:A,isTranscriptMode:F,verbose:Z,hideInTranscript:F&&!(!$||z===$)})}';
const thinkingReplacement = 'case"thinking":{return K5.createElement(gkA,{addMargin:Q,param:A,isTranscriptMode:!0,verbose:Z,hideInTranscript:!1})}';
