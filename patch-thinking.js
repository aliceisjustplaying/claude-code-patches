...
// Display help
if (showHelp) {
  console.log('Claude Code Thinking Visibility Patcher v2.1.6');
  console.log('==============================================\n');
...
// Thinking Visibility Patch (v2.1.6)
...
const thinkingSearchPattern = 'case"thinking":{if(!F&&!Z)return null;return Z5.createElement(_bA,{addMargin:Q,param:A,isTranscriptMode:F,verbose:Z,hideInTranscript:F&&!(!$||z===$)})}';
const thinkingReplacement = 'case"thinking":{return Z5.createElement(_bA,{addMargin:Q,param:A,isTranscriptMode:!0,verbose:Z,hideInTranscript:!1})}';
